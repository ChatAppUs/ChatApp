...
This compares source coverage with the product capabilities documented by the competitors; it does not treat a page or endpoint as proof of production parity.
