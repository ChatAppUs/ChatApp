...
5. **Addressing is incomplete.** Local Wi-Fi, Wi-Fi Direct and Bluetooth use different address spaces and packet framing. The route table needs canonical device IDs, signed beacons, expiry, transport-specific endpoint records and route scoring.
